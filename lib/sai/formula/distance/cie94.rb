      ...
      module CIE94
        ...
        class << self
          ...
          def calculate(color1, color2, **options)
            ...
            Sai.cache.fetch(CIE94, :calculate, color1.identity, color2.identity) do
